...
@task
def test_publisher_image(ctx):
    """
    Task to test dashboard docker container
    :param ctx: context object
    :return: None
    """
    ctx.run('pytest -c pytest.ini tests/test_publisher_image.py')
...
def test_publisher(ctx):
    """
    Task to validate app functionality.
    :param ctx: context object
    :return: None
    """
    ctx.run('pytest -c pytest.ini tests/test_publisher.py')
